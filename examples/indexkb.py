...
if __name__ == "__main__":
    if len(sys.argv) < 3:
        print >> sys.stderr, "Usage: IndexKB <master> <files>"
        exit(-1)
    sc = SparkContext(sys.argv[1], "Index Knowledge Base")

    # knowledge base articles
    kbfiles = sys.argv[2]
    
    #kbfiles="file:/home/training/training_materials/sparkdev/data/kb/*")
