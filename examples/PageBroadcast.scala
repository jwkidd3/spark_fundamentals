...
var pagefile = "/home/training/training_materials/sparkdev/data/kblist.txt"
...
var pagesbc = sc.broadcast(pages)

// key logs by page ID requested
var logfile = "file:/home/training/training_materials/sparkdev/data/weblogs/*"      
...
var pagelogs = logs.map(pair => (pagesbc.value(pair._1),pair._2))
